...
(function () {
  ...
  function Ua(m, q, s) {
    "millisecond" === s
      ? m.setMilliseconds(m.getMilliseconds() + 1 * q)
      : "second" === s
      ? m.setSeconds(m.getSeconds() + 1 * q)
      : "minute" === s
      ? m.setMinutes(m.getMinutes() + 1 * q)
      : "hour" === s
      ? m.setHours(m.getHours() + 1 * q)
      : "day" === s
      ? m.setDate(m.getDate() + 1 * q)
      : "week" === s
      ? m.setDate(m.getDate() + 7 * q)
      : "month" === s
      ? m.setMonth(m.getMonth() + 1 * q)
      : "year" === s && m.setFullYear(m.getFullYear() + 1 * q);
    return m;
  }
  function ha(m, q) {
    var s = !1;
  ...
  function cb(m) {
    if ($.fSDec)
      m[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"), function () {
        $._fTWm && $._fTWm(m);
      });
  }
  function Va(m, q, s) {
  ...
  function db(m) {
    if (!Za) {
      ...
      "undefined" === typeof ra.Chart.creditHref
        ? ((m.creditHref = ja("iuuqr;..b`ow`rkr/bnl.")),
          (m.creditText = ja("B`ow`rKR/bnl")))
        : ((q = m.updateOption("creditText")),
          (s = m.updateOption("creditHref")));
  ...
  function va(m, q, s) {
    q.getAttribute("state") ||
      ((q.style.backgroundColor = m.toolbar.backgroundColor),
    ...
    q.getAttribute("state") !== s &&
      (q.setAttribute("state", s),
      ...
      q.setAttribute("title", m._cultureInfo[s + "Text"]),
      (q.innerHTML =
        "<img style='height:95%;' src='" +
        eb[s].image +
        "' alt='" +
        m._cultureInfo[s + "Text"] +
        "' />"));
  }
  function Na() {
  ...
  function Y(m, q, s, v, x) {
    ...
    this.theme && y(q) && y(v)
      ...
      : this.parent &&
        ...
        this.parent.themeOptions[q] &&
        (null === v
          ? (m = this.parent.themeOptions[q])
          : 0 < this.parent.themeOptions[q].length &&
            ((v = Math.min(this.parent.themeOptions[q].length - 1, v)),
            (m = this.parent.themeOptions[q][v])));
    this.themeOptions = m;
  ...
  (function () {
    $.fSDec = function (m) {
      for (var q = "", s = 0; s < m.length; s++)
        q += String.fromCharCode(
          Math.ceil(m.length / 57 / 5) ^ m.charCodeAt(s)
        );
      return q;
    };
    $.obj = {
    ...
    $._fTWm = function (m) {
      if ("undefined" === typeof $.pro.sCH && !Za)
        try {
  ...
  var Wa = {},
        ...
        return (Q = C.replace(m, function (c) {
          switch (c) {
            ...
            case "K":
              return V
                ? "UTC"
                : (String(R).match(x) || [""]).pop().replace(z, "");
            case "z":
        ...
        if (((q = R[W]), "." === q && 0 > C)) C = W;
          ...
          if ("%" === q) z *= 100;
            ...
            ("E" !== q[0] && "e" !== q[0]) ||
              ...
              (O = !0);
          0 > C
            ? (Q.push(q), "#" === q || "0" === q ? P++ : "," === q && V++)
            : (G.push(q), ("#" !== q && "0" !== q) || S++);
        }
      O &&
        ((q = Math.floor(m)),
        (R = -Math.floor(Math.log(m) / Math.LN10 + 1)),
        ($ = 0 === m ? 0 : 0 === q ? -(P + R) : String(q).length - P),
        (z /= Math.pow(10, $)));
      0 > C && (C = W);
      z = (m * z).toFixed(S);
      q = z.split(".");
        ...
        if (((q = Q.pop()), "#" === q || "0" === q))
          if ((C++, C === P)) {
            ...
            for (; 0 < Y.length; )
              (s = Y.pop() + s),
                O++,
                0 === O % R && W === V && 0 < Y.length && (s = x + s);
          } else
            0 < z.length
              ? ((s = z.pop() + s), S++, O++)
              : "0" === q && ((s = "0" + s), S++, O++),
              0 === O % R && W === V && 0 < z.length && (s = x + s);
        else
          ("E" !== q[0] && "e" !== q[0]) ||
          "0" !== q[q.length - 1] ||
          !/[eE][+-]*[0]+/.test(q)
            ? "," === q
              ? (W++, (R = O), (O = 0), 0 < z.length && (s = x + s))
              : (s =
                  1 < q.length &&
                  (('"' === q[0] && '"' === q[q.length - 1]) ||
                    ("'" === q[0] && "'" === q[q.length - 1]))
                    ? q.slice(1, q.length - 1) + s
                    : q + s)
            : ((q =
                0 > $
                  ? q.replace("+", "").replace("-", "")
                  : q.replace("-", "")),
              (s += q.replace(/[0]+/, function (m) {
                return ha($, m.length);
              })));
      x = "";
      for (Q = !1; 0 < G.length; )
    ...
    Pa = function (m) {
      ...
      m.offsetX || 0 === m.offsetX
        ? ((q = m.offsetX), (s = m.offsetY))
        : m.layerX || 0 == m.layerX
        ? ((q = m.layerX), (s = m.layerY))
        : ((q = m.pageX - m.target.offsetLeft),
          (s = m.pageY - m.target.offsetTop));
      return { x: q, y: s };
    },
    Ya = !0,
  ...
  Y.prototype.setOptions = function (m, q) {
    if (ra[this._defaultsKey]) {
      ...
      for (v in s)
        "publicProperties" !== v &&
          s.hasOwnProperty(v) &&
          (this[v] = m && v in m ? m[v] : q && v in q ? q[v] : s[v]);
    }
  };
  Y.prototype.get = function (m) {
    ...
    if (
      q.hasOwnProperty(m) ||
      (q.publicProperties && q.publicProperties.hasOwnProperty(m))
    )
      return this[m];
    window.console &&
      window.console.log(
  ...
  Y.prototype.addTo = function (m, q, s, v) {
    ...
    (y.publicProperties &&
      ...
      ? (this.options._isPlaceholder && this.createUserOptions(),
        ...
        (m = this.options[m]),
        (s = "undefined" === typeof s || null === s ? m.length : s),
        m.splice(s, 0, q),
    ...
    if ("undefined" !== typeof m || this.options._isPlaceholder)
      if (
        ...
        (this.options = "undefined" === typeof m ? {} : m),
          ...
          this.optionsName
            ? (q = this.optionsName)
            : (q = this._defaultsKey) && 0 !== q.length
            ? ((s = q.charAt(0).toLowerCase()),
              1 < q.length && (s = s.concat(q.slice(1))),
              (q = s))
            : (q = void 0),
          (m[q] = this.options);
  };
  ...
  Y.prototype.updateOption = function (m) {
    var q = ra[this._defaultsKey],
      ...
      z = this._index;
    this.theme && y(x) && y(z)
      ? (s = y(ya[this.theme]) ? ya.light1 : ya[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[x] &&
        (null === z
          ? (s = this.parent.themeOptions[x])
          : 0 < this.parent.themeOptions[x].length &&
            ((s = Math.min(this.parent.themeOptions[x].length - 1, z)),
            (s = this.parent.themeOptions[x][s])));
    this.themeOptions = s;
    m in q &&
      (v = m in this.options ? this.options[m] : s && m in s ? s[m] : q[m]);
  ...
  Y.prototype.addEventListener = function (m, q, v) {
    m &&
      ...
      this._eventListeners[m].push({ context: v || this, eventHandler: q }));
  };
  ...
  Ea.prototype.registerSpace = function (m, q) {
    "top" === m
      ? (this._topOccupied += q.height)
      : "bottom" === m
      ? (this._bottomOccupied += q.height)
      : "left" === m
      ? (this._leftOccupied += q.width)
      : "right" === m && (this._rightOccupied += q.width);
  };
  ...
  Ia.prototype.render = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              v.width - 4 - S * ("center" === this.horizontalAlign ? 2 : 1)),
      ...
      y(this.padding) || "number" !== typeof this.padding
        ...
        : (Q = 2.5 * this.padding);
      this.wrap ||
        (G = Math.min(G, Math.max(1.5 * this.fontSize, this.fontSize + Q)));
      G = new ka(this.ctx, {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((x = v.y2 - 2 - Q.height), (C = "bottom")),
          "left" === this.horizontalAlign
            ? (s = v.x1 + 2)
            : "center" === this.horizontalAlign
            ? (s = v.x1 + v.width / 2 - Q.width / 2)
            : "right" === this.horizontalAlign && (s = v.x2 - 2 - Q.width - S),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ...
            ? ((s = v.x2 - 2),
              ...
              (this.height = Q.width))
            : "center" === this.horizontalAlign &&
              ((x = m.y1 + (m.height / 2 - Q.height / 2)),
              (s = m.x1 + (m.width / 2 - Q.width / 2)),
              (C = "center"),
              (this.width = Q.width),
              (this.height = Q.height)),
          (R = "center"));
  ...
  La.Chart = (function () {
          ...
          O(
            ...
            function () {
              f ||
                ...
                0 >= navigator.userAgent.search("MSIE") &&
                  pa(a, a._menuButton.childNodes[0], {
                    WebkitFilter: "invert(100%)",
                    filter: "invert(100%)",
                  }));
            },
    ...
    s.prototype.render = function (a) {
      ...
      if (this.options.subtitles)
        for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++)
          (b = new Oa(this, this.options.subtitles[a], a)),
    ...
    s.prototype.getDataPointAtXY = function (a, f, b) {
      ...
      for (b = 0; b < c.length; b++)
        if (
          ...
          if (
            ((e = ma("markerSize", c[b].dataPoint, c[b].dataSeries) || 8),
            c[b].distance <= e / 2)
          ) {
            f = !0;
            break;
    ...
    s.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var H = k.dataPoint.indexLabelFormatter
          ? k.dataPoint.indexLabelFormatter(T)
          ...
          ? k.dataSeries.indexLabelFormatter(T)
          ...
          D &&
            ...
            0 <= r.indexOf("bar") || ("error" === r && k.axisSwapped)
              ...
              : f.lineTo(
                  p + l / 2,
                  n +
                    ((n < k.point.y ? t : -t) + ("horizontal" === T ? t : -t)) /
                      2
                ),
            f.stroke());
        }
        ...
        for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            for (var q = !1, u = 0; u < r.length; u++)
              if (
                ((T = r[u].x.getTime ? r[u].x.getTime() : r[u].x),
                !(
                  ...
                  D || q
                    ...
                    : (b.lineTo(T, H),
                      ...
                      0 == u % 500 &&
                        ...
                        b.beginPath(),
                        b.moveTo(T, H),
                        v && (c.stroke(), c.beginPath(), c.moveTo(T, H))));
                  h = { x: T, y: H };
                  u < r.length - 1 &&
                    (m !== (r[u].lineColor || w) ||
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            for (var q = !1, u = 0; u < r.length; u++)
              if (
                ((T = r[u].getTime ? r[u].x.getTime() : r[u].x),
                !(
                  T < a.axisX.dataInfo.viewPortMin ||
                  (T > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !q))
                  ...
                  u < r.length - 1 &&
                    ...
                    b.setLineDash &&
                      (r[u].lineDashType
                        ...
                        : ((p = k.lineDashType), b.setLineDash(d))));
                  if (0 < r[u].markerSize || 0 < k.markerSize)
                    (s = k.getMarkerProperties(u, T, H, b)),
                      g.push(s),
                      (A = S(A)),
                      v &&
                        g.push({
                ...
                if ("number" !== typeof r[D].y)
                  ...
                  D < r.length - 1 &&
                    ...
                    c.setLineDash &&
                      (r[D].lineDashType
                        ? ((p = r[D].lineDashType),
                          (H[H.length - 1].newLineDashArray = G(
                            p,
                            k.lineThickness
                          )))
                        : ((p = k.lineDashType),
    ...
    s.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
          ...
          if (0 < u.length)
            for (
              var s = 5 < d && D.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
                    ...
                    (p.connectNullData
                      ? c.setLineDash &&
                        ...
                        (p.options.nullDataLineDashType ||
                          !n[d - 1].lineDashType) &&
                        ((q[q.length - 1].newLineDashArray = M),
              ...
              if (
                ...
                "number" !== typeof m[D].y
                  ...
                  : ((u = a.axisX.convertValueToPixel(q)),
                    ...
                    D < m.length - 1 &&
                      (K !== (m[D].lineColor || z) ||
                        J !== (m[D].lineDashType || w.lineDashType)) &&
                      (c(),
                      (K = m[D].lineColor || z),
                      (g.strokeStyle = K),
                      g.setLineDash &&
                        (m[D].lineDashType
                          ? ((J = m[D].lineDashType),
                            g.setLineDash(G(J, w.lineThickness)))
                          : ((J = w.lineDashType), g.setLineDash(da)))),
                    (q = w.dataPointIds[D]),
                  ...
                  p < z.length - 1 &&
                    ...
                    c.setLineDash &&
                      (z[p].lineDashType
                        ...
                        : ((y = A.lineDashType), c.setLineDash(ca))));
            ...
            for (
              ...
              if (
                ...
                0 < na &&
                  ...
                  (b.strokeStyle = xa),
                  (b.lineWidth = na),
                  b.setLineDash && b.setLineDash(G(C, na)),
                  b.moveTo(l - E, k),
                  b.lineTo(l - E, t),
                  b.stroke(),
                  b.moveTo(l - E, p),
                ...
                0 < P &&
                  (b.beginPath(),
                  (b.globalAlpha = 1),
                  b.setLineDash && b.setLineDash(G(R, P)),
                  (b.strokeStyle = Q),
                  (b.lineWidth = P),
                  b.moveTo(B, n - L),
                  b.lineTo(A, n - L),
                ...
                0 < J &&
                  (b.beginPath(),
                  b.setLineDash && b.setLineDash(G(ca, J)),
                  (b.strokeStyle = K),
                  (b.lineWidth = J),
                  b.moveTo((l - da / 2) << 0, p - aa),
                  b.lineTo((l + da / 2) << 0, p - aa),
                  b.stroke(),
                  b.moveTo((l - da / 2) << 0, t + aa),
                  b.lineTo((l + da / 2) << 0, t + aa),
                  b.stroke());
                b.restore();
                v &&
                  ((e = S(N)),
                  ...
                  0 < na &&
                    (c.moveTo(l - M - E, k),
                    c.lineTo(l - M - E, Math.max(t, p)),
                    c.stroke(),
                    c.moveTo(l - M - E, Math.min(t, p)),
                    c.lineTo(l - M - E, r),
                    c.stroke()),
                  W(
                    c,
                  ...
                  0 < J &&
                    (c.beginPath(),
                    (c.lineWidth = J),
                    c.moveTo(l + da / 2, p - aa),
                    c.lineTo(l - da / 2, p - aa),
                    c.stroke(),
                    c.moveTo(l + da / 2, t + aa),
                    c.lineTo(l - da / 2, t + aa),
                    c.stroke()));
                (H[h].indexLabel ||
                  q.indexLabel ||
              ...
              if (null !== B) {
                ...
                if (0 > z) {
                  for (var G = (y = 0), ta = 0; ta < r.length; ta++)
                    ta !== a &&
                      d[ta].hemisphere === l.hemisphere &&
                      (d[ta].indexLabelTextBlock.y < l.indexLabelTextBlock.y
                        ? y++
                        : G++);
                  y = (z / (y + G || 1)) * G;
                  var G = -1 * (z - y),
                  ...
                  "right" === l.hemisphere
                    ? ((ta = g(a, y)),
                      (G = -1 * (z - ta)),
                      (I = g(B, G)),
                      +I.toFixed(v) < +G.toFixed(v) &&
                        +ta.toFixed(v) <= +y.toFixed(v) &&
                        g(a, -(G - I)))
                    : ((ta = g(B, y)),
                      (G = -1 * (z - ta)),
                      (I = g(a, G)),
    ...
    s.prototype.renderFunnel = function (a) {
        ...
        if (e)
          for (h = F.length - 1; 0 <= h; h--)
            (a = N[h]),
              ...
              u.reversed
                ? (F[h].textBlock.y + F[h].height > U + C &&
                    (F[h].textBlock.y = U + C - F[h].height),
                  F[h].textBlock.y < sa - C && (F[h].textBlock.y = sa - C))
                : (F[h].textBlock.y < U - C && (F[h].textBlock.y = U - C),
                  F[h].textBlock.y + F[h].height > sa + C &&
                    (F[h].textBlock.y = sa + C - F[h].height));
      }
      function g() {
        var a, b, c, e;
          ...
          for (var f = 0; f < N.length; f++)
            0 == F[f].textBlock.text.length
              ...
              : ((a = N[f]),
                ...
                u.reversed
                  ? (F[f].textBlock.y + F[f].height > U + C &&
                      (F[f].textBlock.y = U + C - F[f].height),
                    F[f].textBlock.y < sa - C && (F[f].textBlock.y = sa - C))
                  : (F[f].textBlock.y < U - C && (F[f].textBlock.y = U - C),
                    F[f].textBlock.y + F[f].height > sa + C &&
                      (F[f].textBlock.y = sa + C - F[f].height)));
        else
      ...
      function h() {
          ...
          for (var k, l = 1; l < h; l++) {
            ...
            for (var r = F.length - 1; 0 <= r; r--)
              !F[r].isDirty &&
                ...
                ((k = n(r)),
                !(k >= F.length - 1) &&
                  F[r].textBlock.y + F[r].height + ga > F[k].textBlock.y &&
                  (F[r].textBlock.y =
          ...
          for (k = N.length - 1; 0 < k; k--)
            if (!F[k].isDirty) {
              ...
              if (F[k].textBlock.y < F[e].textBlock.y + F[e].height) {
                ...
                for (
                  h = 0;
                  F[f].textBlock.y < F[e].textBlock.y + F[e].height + ga;
        ...
        for (var d, e, f, g, h, k, t = 1, r = 0; r < 2 * t; r++) {
          for (
            ...
            (f = F[m]),
            (g = f.textBlock),
            (k = (h = n(m) < N.length ? F[n(m)] : null) ? h.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              h &&
              e + d + ga > +k.y.toFixed(6) &&
              ((d = g.y + d + ga - k.y),
              (e = a(m, -d)),
      ...
      function l(a, b) {
        return (
          (b < N.length ? F[b].textBlock.y : u.reversed ? U + C : sa + C) -
          (0 > a
            ? u.reversed
              ? sa - C
              : U - C
            : F[a].textBlock.y + F[a].height + ga)
        );
      }
      function t(a, b, c) {
        var d,
        ...
        if (0 === la.length) h = ja;
          ...
          e =
            (C *
              (1 != la.length || (0 != la[0] && la[0] != N.length - 1)
                ? 2
                : 1)) /
            k();
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]],
            ...
            A = 0,
            P = z.height - 2 * C,
            M = Math.min(z.width - 2 * B, 2.8 * z.height),
            K = !1,
            J = 0;
          J < x.length;
          J++
          ...
          if (
            ...
            (!K && "function" === typeof u.indexLabelFormatter) ||
              "function" === typeof x[J].indexLabelFormatter)
          )
            K = !0;
        K =
          K ||
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
          ...
          var V = (30 * (Q - a)) / 100;
          "funnel" === u.type
            ? ((O = y(u.options.neckHeight) ? 0.35 * P : u.neckHeight),
              ...
              E > a ? (E = a - 0.5) : 0 >= E && (E = 0))
            : "pyramid" === u.type &&
              ((E = O = 0), (u.reversed = u.reversed ? !1 : !0));
          var B = J + a / 2,
            Y = J,
            W = J + a,
            U = u.reversed ? aa : R,
          ...
          if (-1 !== J) {
            if (u.reversed)
              for (M.push(X), E = J.length - 1; 0 < E; E--)
                (X += J[E]), M.push(X);
            else for (E = 0; E < J.length; E++) (X += J[E]), M.push(X);
            if (u.reversed)
              for (E = 0; E < J.length; E++)
                M[E] < ba
                  ? (a.push(L), B.push(Z), (fa = E))
                  : (a.push((M[E] - U + ea * Y) / ea),
                    B.push((M[E] - U + ha * W) / ha));
            else
              for (E = 0; E < J.length; E++)
                M[E] < ba
                  ? (a.push((M[E] - U + ea * Y) / ea),
            ...
            for (E = 0; E < x.length; E++)
              x[E].exploded &&
                ((J = !0), u.reversed ? la.push(x.length - 1 - E) : la.push(E));
            ...
            K &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || s.animationEnabled || r(S),
            ...
            var d = (n.legendMarkerType = n.legendMarkerType
                ...
                ? "error" === n.type && n._linkedSeries
                  ? n._linkedSeries.legendMarkerType
                    ? n._linkedSeries.legendMarkerType
                    : R.getDefaultLegendMarker(n._linkedSeries.type)
                  : R.getDefaultLegendMarker(n.type)
                : n.markerType),
              m = n.legendText
                ? n.legendText
            ...
            if (((b = this.logLabelValues[c]), b < this.viewportMinimum)) c++;
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  ? this.labels[m]
                  : X(m, this.valueFormatString, this.chart._cultureInfo)),
                (a = new ka(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: g,
      ...
      if ("normal" === e) {
        for (
          ...
          if (f && 0 < f.length)
            for (d = 0; d < f.length; d++)
              (f[d].lineCoordinates.x1 = Math.round(g.x1 + N + L)),
                ...
                f[d]._labels &&
                  ...
                  (u =
                    ...
                    (l.textBlock.height - l.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(l.textBlock.angle)))),
                m.panEnabled
                  ? (X = m.sessionVariables.axisX2.height)
                  : (m.sessionVariables.axisX2.height = X),
                (l = Math.round(g.y1)),
                (k = Math.round(g.y2 + f[d].margin)),
                (f[d].lineCoordinates.y1 = l + X + W - U),
        ...
        for (S = []; 4 > s; ) {
          ...
          if (b && 0 < b.length)
            for (d = 0; d < b.length; d++)
              (b[d].lineCoordinates = {}),
                ...
                (t = Math.round(
                  g.x2 - X - W > m.width - 10 ? m.width - 10 : g.x2 - X - W
                )),
                b[d].labelAutoFit &&
                  !y(z) &&
                  (0 < !a.length &&
          ...
          if (c && 0 < c.length)
            ...
            M.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          P.push(M);
          if (b && 0 < b.length)
            for (d = 0; d < b.length; d++)
          ...
          if (c && 0 < c.length)
            for (d = c.length - 1; 0 <= d; d--)
              c[d] &&
                ((l = Math.round(g.y1)),
                (k = Math.round(g.y1 + (M[d] + c[d].margin + U))),
                ...
                b && 0 < b.length
                  ? Math.round(
                      b[0]
                        ...
                        : g.y2 - Y > m.height - Math.max(L, 10)
                        ? m.height - Math.max(L, 10)
                        : g.y2 - Y
                    )
                  : g.y2 > m.height - Math.max(L, 10)
                  ? m.height - Math.max(L, 10)
                  : g.y2;
              if (b && 0 < b.length)
            ...
            for (d = 0; d < f.length; d++) {
              ...
              if (c && 0 < c.length)
                for (L = 0; L < c.length; L++)
                  c[L] &&
                    c[L].labelAutoFit &&
                    ((t = c[L].lineCoordinates.x2), (h = t - X));
              f[d].lineCoordinates = {
                x1: t + V,
                y1: l,
                x2: t + V,
    ...
    C.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (e = c || !y(f[g].options.spacing)),
          (f[g].spacing =
            P(f[g].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
            ...
            (c / 1 <= a
              ...
              : ((this.interval =
                  c / (1 * V.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(
                        C.getNiceNumber(c / (a - 1), !0) / V.yearDuration
                      )),
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ((k = this.chart.getDataPointAtXY(a, f, b)))
            ...
            if (
              ((k = Xa(a, f, this.chart._eventManager.ghostCtx)),
              0 < k &&
